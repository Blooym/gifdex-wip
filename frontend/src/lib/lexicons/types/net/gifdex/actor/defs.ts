...
const _profileViewMinimalSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("net.gifdex.actor.defs#profileViewMinimal"),
  ),
  avatar: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.genericUriString()),
  did: /*#__PURE__*/ v.didString(),
  /**
...
type profileViewMinimal$schematype = typeof _profileViewMinimalSchema;
...
export interface profileViewMinimalSchema extends profileViewMinimal$schematype {}
...
export const profileViewMinimalSchema =
  _profileViewMinimalSchema as profileViewMinimalSchema;
...
> {}
export interface ProfileViewMinimal extends v.InferInput<
  typeof profileViewMinimalSchema
> {}
